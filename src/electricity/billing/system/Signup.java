        ...
        meterText.addFocusListener(new FocusListener() {
            ...
            public void focusLost(FocusEvent e) {
                try{
                    ...
                    Logger.getLogger(Signup.class.getName()).log(Level.SEVERE, "Failed during meter focus lookup", E);
                }
            }
        });
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == create) {
            ...
            try {
                ...
                Logger.getLogger(Signup.class.getName()).log(Level.SEVERE, "Failed to create account", E);
            }
